...
import logo from 'X:/MCF/MCFSite/mld/src/images/Logo_MCF_Full.png';
...
const NavBar = () => {
    ...
    return (
        <nav className={`fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-16 ${!top ? 'bg-[#40649c] shadow-lg' : 'bg-[#40649c]'}`}>
        ...
        <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
            <HashLink smooth to="/#hero">
                <img 
                    src={logo}
                    alt="MCF-Logo" 
                    className="h-8 w-29 md:h-11 md:w-30" 
                />
            </HashLink>
        </div>
